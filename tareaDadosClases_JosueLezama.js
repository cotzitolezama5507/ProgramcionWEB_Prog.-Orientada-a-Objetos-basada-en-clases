...
//Creación de el contador de los juegos y el inicio de cada juego, al igual que el ganador del torneo
class JuegoDados {
...
class TorneoDados {
    ...
    jugar() {
        ...
        do {
            //Tiramos dados y asignamos los nombres en la clase
            let partida = new JuegoDados(i, p1, p2)
            partida.tirarDados()
            //Iniciamos el método
            let ganador = partida.determinaGanador()
            
            //Verificamos el ganador de cada ronda
            ...
            //El ganador de la ronda o si se empató, se mandará al arreglo
            this.jugadas.push(partida)

            //Vemos si ha llegado al limite de ganadas para ganar el torneo
            ...
            //Repetimos este proceso hasta que alguno de los participantes llegue a 3
    ...
    resultado() {
        //Condicional para saber cuando se gane el torneo
...
//Asignamos los nombres y iniciamos el torneo
let p1 = new Jugador("Lu")
let p2 = new Jugador("Sosa")
...
//Imprimimos el ganador de gada ronda
...
console.log("THE WINNER OF THE TOURNAMENT: " + tournament.resultado() + " CONGRATULATIONS")
